        ...
        <div class="wrapper">
            <div class="container">
                ...
                <form action = "org_filter_backend.php" method = "POST">
                    ...
                    Location: <input name = "location" placeholder = "Enter Location of Candidates"><br>
			...
			Skill: <br><select id="skill" name="skill">                      
            ...
            Qualification:<br> <select id="degree" name="degree">                      
			  ...
			  <option value="B.Tech+M.Tech(Dual)">B.Tech+M.Tech(Dual)&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</option>
			</select><br><br><br>
